...
ActiveRecord::Schema.define(version: 20170105063941) do
  ...
  create_table "foods", force: :cascade do |t|
    ...
    t.integer  "min_prepare_time", limit: 2,                             default: 24,   null: false
    t.integer  "order_count",      limit: 4,                             default: 0,    null: false
    t.integer  "quota",            limit: 4,                             default: 100
    t.boolean  "is_combo",                                               default: true
  end
